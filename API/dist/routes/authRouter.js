 ...
 */
router.post('/forgot-password', (0, asyncHandler_1.default)(authController_1.forgotPassword));
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/reset-password', (0, asyncHandler_1.default)(authController_1.resetPassword));
